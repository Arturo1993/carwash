...
if(isset($_SESSION['user']) && $_SESSION['user'] == 'no user') {
    echo "თქვენ ვერ გაიარეთ ავტორიზაცია";
}
...
<div class="container">
    ...
    <div class="card card-container">
        ...
        <form class="form-signin" method="post" action="Users.php">
            ...
            <input type="password" id="inputPassword" class="login_box" placeholder="******" required name="password">
            <div id="remember" class="checkbox">
                <label>

                </label>
            </div>
            <button class="btn btn-lg btn-primary" type="submit" name="subm">Login</button>
        </form><!-- /form -->
    </div><!-- /card-container -->
</div><!-- /container -->
