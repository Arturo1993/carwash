    ...
    <!-- sidebar: style can be found in sidebar.less -->
      <section class="sidebar">
          ...
          <ul class="sidebar-menu">
              ...
              <li><a href="../../index2.php"><i class="fa fa-book"></i> <span>Daily</span></a></li>
              <li><a href="advanced2.php"><i class="fa fa-files-o"></i> <span>Exspenses</span></a></li>
              <li><a href="../Manage_goods_details.php"><i class="fa fa-book"></i> <span>Exspenses</span></a></li>
    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Manage Goods Details</h3>
...
<script>
    ...
    $( document ).ready(function() {
        ...
        $("#br_id").on( "click", function() {
            ...
            //.val იღებს ინფუთად შეტანილ მნიშვნელობებს  ში შეყვანილ მნიშვნელობას
